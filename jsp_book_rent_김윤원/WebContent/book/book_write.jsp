...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	String LastPcode =	dao.checkLastBcode();
    	
    	LastPcode = LastPcode.substring(1);
    	
    	int LPC = Integer.parseInt(LastPcode) + 1;
    	
    	String NewBcode = String.format("B%03d", LPC);
...
<head>
<meta charset="UTF-8">
<title>도서 등록</title> <style type="text/css">
...
<script type="text/javascript">
	function goSave(){
		...
		book.method = "post"; //post , get
		book.action = "db_book_write.jsp";
		book.submit();
	}
...
<table border = "1" width="400">
		...
		<tr>
			...
			<td>
				<input type="hidden" name = "t_code" value = <%=NewBcode%>   /><%=NewBcode %>
		...
		<tr>
			<th>출판사</th>
			<td>
				<input type= "text" name = "t_pub"/>
			</td>
		</tr>
		<tr>
			<th>저자</th>
			<td><input type="text" name ="t_writer" size = "10"/></td>
		</tr>
		
		<tr>
			<th>등록 일자</th>
			<td><input type="date" max="2025-06-02" name ="t_regDate" value="2025-05-27" />
			 <input type="hidden" name="t_rent_able" value = "y" /></td>
